...
function walk(seed, n, start, drift, vol) {
...
function StatCard({
  ...
  const format = card.format ?? ((v) => formatCount(v, 1));
...
export function DefaultStatCards(props) {
  return <StatCards {...props} />;
}

export function BudgetStatCards(props) {
