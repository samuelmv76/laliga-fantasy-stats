...
export function resample(values, n = MORPH_SAMPLES) {
...
export function useTween(target, { duration = 520, enabled = true } = {}) {
...
export function useTweenNumber(target, options) {
...
export function intensityColor(t, hue = 'var(--spectrum-series-1)') {
...
export function onFillClass(intensity) {
