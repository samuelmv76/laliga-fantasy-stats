...
export function winChance(fixture) {
...
function fallbackDifficulty(fixture) {
...
export function fixtureDifficulty(fixture) {
...
export function oddsLabel(fixture) {
  const odds = fixture?.odds
  if (!impliedProbabilities(odds)) return 'Estimación por dificultad del rival'
